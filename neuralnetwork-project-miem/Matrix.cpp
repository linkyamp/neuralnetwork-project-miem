...
//////////////////////////////////////////////////////////////////////////////
/// Инициализация матрицы - выделяем на неё память, обнуляем
/// \param row, col - задают размер матрицы
/////////////////////////////////////////////////////////////////////////////
...
void Matrix::Multi(, const double* neuron, int n, double* c) {
//////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////
/// Умножение транспонированной матрицы на вектор столбец
/// \param const Matrix& m1 - контекстная ссылка на объект класса Matrix
/////////////////////////////////////////////////////////////////////////////
	if (m1.row != n)
		throw std::runtime_error("Error Multi \n");
